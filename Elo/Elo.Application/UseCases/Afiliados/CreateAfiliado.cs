...
public static class CreateAfiliado
{
    public class Command : IRequest<AfiliadoDto>
    {
        ...
        public Elo.Domain.Enums.Status Status { get; set; } = Elo.Domain.Enums.Status.Ativo;
    ...
    public class Handler : IRequestHandler<Command, AfiliadoDto>
    {
        ...
        {
            var afiliado = await _afiliadoService.CriarAfiliadoAsync(
                request.Nome,
                request.Email,
                request.Documento,
                request.Telefone,
