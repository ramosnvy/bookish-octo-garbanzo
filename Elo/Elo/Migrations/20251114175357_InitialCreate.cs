        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorRevenda = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    MargemLucro = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    UsuarioAtribuidoId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tickets_Users_UsuarioAtribuidoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInterna = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RespostasTicket", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RespostasTicket_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RespostasTicket_Users_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RespostasTicket_TicketId",
                table: "RespostasTicket",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_RespostasTicket_UsuarioId",
                table: "RespostasTicket",
                column: "UsuarioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_UsuarioAtribuidoId",
                table: "Tickets",
