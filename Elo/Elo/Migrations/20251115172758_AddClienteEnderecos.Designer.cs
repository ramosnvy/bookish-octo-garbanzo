...
namespace Elo.Migrations
{
    ...
    [Migration("20251115172758_AddClienteEnderecos")]
    partial class AddClienteEnderecos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elo.Domain.Entities.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Elo.Domain.Entities.ClienteEndereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elo.Domain.Entities.Fornecedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elo.Domain.Entities.ClienteEndereco", b =>
                {
                    b.HasOne("Elo.Domain.Entities.Cliente", "Cliente")
                        .WithMany("Enderecos")
            ...
            modelBuilder.Entity("Elo.Domain.Entities.ContaPagar", b =>
                {
                    b.HasOne("Elo.Domain.Entities.Fornecedor", "Fornecedor")
