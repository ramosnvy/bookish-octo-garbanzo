...
public class UnitOfWork : IUnitOfWork
{
    ...
    public UnitOfWork(ApplicationDbContext context)
    {
        ...
        HistoriaStatuses = new Repository<HistoriaStatus>(_context);
        HistoriaTipos = new Repository<HistoriaTipo>(_context);
        HistoriaProdutos = new Repository<HistoriaProduto>(_context);
        Tickets = new Repository<Ticket>(_context);
        TicketTipos = new Repository<TicketTipo>(_context);
        TicketAnexos = new Repository<TicketAnexo>(_context);
    ...
    public IRepository<HistoriaStatus> HistoriaStatuses { get; }
    public IRepository<HistoriaTipo> HistoriaTipos { get; }
    public IRepository<HistoriaProduto> HistoriaProdutos { get; }
    public IRepository<Ticket> Tickets { get; }
    public IRepository<TicketTipo> TicketTipos { get; }
    public IRepository<TicketAnexo> TicketAnexos { get; }
