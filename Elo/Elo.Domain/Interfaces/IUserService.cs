...
public interface IUserService
{
    ...
    Task<User> CriarUsuarioAsync(string nome, string email, string password, string role, int? empresaId = null, Status status = Status.Ativo);
    ...
    Task<User> AtualizarUsuarioAsync(int id, string nome, string email, string role, int? empresaId = null, Status? status = null);
    ...
    Task<IEnumerable<User>> ObterUsuariosPorIdsAsync(IEnumerable<int> ids);
}
