...
public class Pessoa
{
    ...
    public virtual ICollection<Ticket> TicketsComoCliente { get; set; } = new List<Ticket>();
    public virtual ICollection<Ticket> TicketsComoFornecedor { get; set; } = new List<Ticket>();
